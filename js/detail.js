...
function renderProperty(p) {
    ...
    <div >
      ...
      $${p.price}</span>
  <div style="box-sizing: border-box; display: inline;" class="ds-bed-Quantityth-living-area-header">
  <span style="box-sizing: border-box; display: inline;" class="ds-bed-Quantityth-living-area-container">
  <span style="box-sizing: border-box; font-size: 15px; line-height: 1.5;" class="hdp__qf5kuj-4 jGniAU">
  <span style="box-sizing: border-box;">${p.SIZE}</span>
  ...
  <span style="box-sizing: border-box;">${p.Quantity}</span><span style="box-sizing: border-box;" class="hdp__qf5kuj-5 hrNWfo">&nbsp;Quantity</span></span>
  </button>
  <span style="box-sizing: border-box; border-style: solid; border-width: 0px 1px 0px 0px; border-color: #d1d1d5; margin-right: 8px; padding-right: 8px;" class="hdp__qf5kuj-6 iDzikP"></span>
  <span style="box-sizing: border-box; font-size: 15px; line-height: 1.5;" class="hdp__qf5kuj-4 jGniAU">
  ...
  <div style="box-sizing: border-box; flex: 1 1 0%; width: 468px;" class="ds-summary-row-content">
     <p style="margin: 0in; line-height: 18pt; Quantityckground: white; font-size: 11pt; font-family: Calibri, sans-serif;">
  ...
  <p style="margin: 0in; line-height: 18pt; Quantityckground: white; font-size: 11pt; font-family: Calibri, sans-serif;"><b>
  <span style="font-size: 12.0pt; font-family: 'Open Sans', sans-serif; color: #2a2a33;">&nbsp;</span></b></p>
  <p style="line-height: 18pt; Quantityckground: white; margin: 0in 0in 8pt; font-size: 11pt; font-family: Calibri, sans-serif;">
